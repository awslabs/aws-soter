...
/** Attempt to find faulty configurations in the non-broken bounded buffer implementation. */
public class FindConfigurationsInBufferHarness {
    ...
    public void run() {
        ...
        BoundedBufferWithLocksAndConditions buffer = new BoundedBufferWithLocksAndConditions(bufferSize);
